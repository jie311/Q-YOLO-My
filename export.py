...
def run(
    ...
    model = attempt_load(weights, device=device, inplace=True, fuse=False)  # load FP32 model
    # Checks
...
def parse_opt():
    ...
    parser.add_argument('--weights', nargs='+', type=str, default='/home/omnisky/WMZ/yolov5-6.2/yolov5s.pt', help='model.pt path(s)')
