...
def runexport(
    ...
    # model = attempt_load(weights, device="cpu", inplace=True, fuse=False)
    model.to("cpu")
...
if __name__ == '__main__':
    model = attempt_load("/home/meize/WMZ/yolov5-6.2/yolov5s.pt", device="cpu", inplace=True, fuse=False)

    # quant_modules.initialize()
    # model = Qattempt_load("D:\Object_d\yolosystem\yolov5-6.2\models\momo.pt", device="cpu", inplace=True, fuse=False)
    runexport(model, weights="/home/meize/WMZ/yolov5-6.2/yolov5s.pt")