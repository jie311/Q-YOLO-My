...
class MaxCalibrator(_Calibrator):
    ...
    """
    def __init__(self, num_bits, axis, unsigned, flag, track_amax=False):
        super(MaxCalibrator, self).__init__(num_bits, axis, unsigned, flag)
    ...
    def collect(self, x):
        ...
        # 最大值
        local_amax = quant_utils.reduce_amax(x, axis=reduce_axis, flag=self._flag).detach()       
