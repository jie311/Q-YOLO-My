...
def parse_opt():
    ...
    parser.add_argument('--weights', nargs='+', type=str, default="/home/meize/WMZ/yolov5-6.2/yolov5s.pt",help='model path(s)')
    parser.add_argument('--source', type=str, default="/home/meize/WMZ/Datasets/coco2017/images/val2017", help='file/dir/URL/glob, 0 for webcam')
